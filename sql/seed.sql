...
-- ID 1
(1,'vi','Điện thoại'), (1,'en','Phones'), (1,'ja','電話'), (1,'zh','手机'),
-- ID 2
(2,'vi','Phụ kiện'),  (2,'en','Accessories'), (2,'ja','アクセサリー'), (2,'zh','配件'),
-- ID 3
(3,'vi','Laptop'),    (3,'en','Laptops'), (3,'ja','ノートPC'), (3,'zh','笔记本电脑'),
-- ID 4
(4,'vi','Phần mềm'),  (4,'en','Software'), (4,'ja','ソフトウェア'), (4,'zh','软件');
...
(7,'zh','笔记本电脑 L5','Core i5，16GB 内存，512GB SSD'),
...
(8,'zh','笔记本电脑 Pro 14','Core i7，14 英寸 Retina 显示屏'),
...
(9,'zh','游戏笔记本 Z','RTX 4060，15.6 英寸 144Hz'),
