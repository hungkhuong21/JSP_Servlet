...
public class ProductDao {
    ...
    public void updateCore(int id, BigDecimal price, BigDecimal weight, int categoryId) {
    ...
    /** ✅ Sửa hoàn toàn hàm tìm kiếm */
    public List<ProductView> searchByName(String keyword, String lang) {
        List<ProductView> list = new ArrayList<>();
        String sql = """
            SELECT p.ProductID, p.Price, p.Weight,
                   pt.ProductName, pt.ProductDescription,
